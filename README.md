...
The tutorial is written so that all the study is done in the folder `run/` (you will move folders `Simulations/` and `Post_processing` inside this folder at some point). Feel free to use a different folder architecture.
